...
def planning_evaluation(pred_trajs_dict, subset=None, only_vehicle=True):
    ...
    if only_vehicle:
        with open('eval_share/gt/planing_gt_segmentation_val','rb') as f:
    ...
    with open('eval_share/gt/gt_traj.pkl','rb') as f:
        gt_trajs_dict = pickle.load(f)

    with open('eval_share/gt/gt_traj_mask.pkl','rb') as f:
...
if __name__ == "__main__":
    ...
    """
    pred_trajs_dict = load_pred_trajs_from_file("eval_share/pred_trajs_dict.pkl")
